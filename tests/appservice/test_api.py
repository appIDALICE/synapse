...
class ApplicationServiceApiTestCase(unittest.HomeserverTestCase):
    ...
    def test_claim_keys(self) -> None:
        ...
        MISSING_KEYS = [
            ...
            ("@alice:example.org", "DEVICE_1", "signed_curve25519:DDDDHg", 1),
            # Known user, missing device.
            ("@alice:example.org", "DEVICE_3", "signed_curve25519:EEEEHg", 1),
            # Unknown user.
            ("@bob:example.org", "DEVICE_4", "signed_curve25519:FFFFHg", 1),
        ]
        ...
        claimed_keys, missing = self.get_success(
            self.api.claim_client_keys(
                ...
                [
                    # Found devices
                    ("@alice:example.org", "DEVICE_1", "signed_curve25519:AAAAHg", 1),
                    ("@alice:example.org", "DEVICE_1", "signed_curve25519:BBBBHg", 1),
                    ("@alice:example.org", "DEVICE_2", "signed_curve25519:CCCCHg", 1),
                ]
                + MISSING_KEYS,
            )
        )
